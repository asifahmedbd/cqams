...
@section('content')
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4">Question Sub Categories</h4>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="col-md-12 bg-light mb-3" style="text-align: right;">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#basicModal">Add Sub Category</button>
                </div>
                
                <div class="table-responsive text-nowrap">
                  <table class="table table-bordered" id="sub_categories">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>Main Category</th>
                    ...
                    <tbody class="table-border-bottom-0">
                          <?php $i=1; ?>
                          @foreach($evaluation_sub_fields as $row)
                            <tr>
                              <td>{{$i}}</td>
                              <td>{{$row->main_category->criteria_name_en}}</td>
